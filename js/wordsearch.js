(function(){
  ...
  function WordSearch(wrapEl, settings) {
    ...
    var categories = { 
      ...
      'b_yliko_psu_fan' : { "Β:: Τροφ. &amp; Ανεμιστ." : ['ΡΕΥΜΑ', 'ΘΟΡΥΒΟΣ', 'ΣΚΟΝΗ', 'ΑΕΡΑΣ'] },
      'b_internet' : { "Β:: Δίκτυο και Διαδίκτυο" : ['ΠΑΡΟΧΟΣ', 'ΑΣΥΡΜΑΤΟ', 'ΔΙΑΔΙΚΤΥΟ', 'ΚΑΛΩΔΙΟ'] },
      'c_viruses' : {"Γ-Δ:: Ιοί Υπολογιστών": ['ΙΟΣ', 'ΣΚΟΥΛΙΚΙ', 'ΑΝΤΙΙΙΚΟ', 'ΕΝΗΜΕΡΩΣΗ', 'ΔΟΥΡΕΙΟΣ', 'ΚΑΚΟΒΟΥΛΟΣ']},
    };
